...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar nacionalidad de un atleta por su nombre\n");
	...
	public void ejecutarBuscarAtleta() {
		String nom = input("ingrese el nombre del atleta");
		Atleta info = null;
		info = calculadora.buscarAtleta(nom);
		Pais pais = info.darPais();
		System.out.println("El pais del atleta ingresado es: " + pais.darNombre());
